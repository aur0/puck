...
export const config: Config = {
  root: {
    ...
    defaultProps: {
      ...
      textSecondary: "#000000", // Default secondary color
      buttonPrimaryColor: "#007bff", // Default blue color for buttons
    },
    render: ({ children, textPrimary, textSecondary, buttonPrimaryColor }) => {
      return (
        <div>
          <style>
            {`
        ...
        return (
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.25rem' }}>
              ...
              <p className="motion-opacity-in-0 motion-preset-slide-down motion-delay-400 motion-duration-500 text-secondary" style={{ fontSize: '1.25rem', maxWidth: '600px' }}>{descriptionText}</p>
